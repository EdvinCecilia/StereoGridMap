...
bool custom_msgs__msg__image_nv12__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._image_nv12.ImageNv12", full_classname_dest, 37) == 0);
  }
  custom_msgs__msg__ImageNv12 * ros_message = _ros_message;
  {  // width
...
{
  /* NOTE(esteve): Call constructor of ImageNv12 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._image_nv12");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImageNv12");
