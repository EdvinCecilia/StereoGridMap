...
class ObjectInfo(metaclass=Metaclass_ObjectInfo):
    ...
    _fields_and_field_types = {
        'numbers': 'uint32',
        'objects': 'sequence<custom_msgs/Object>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.numbers = kwargs.get('numbers', int())
    ...
    def numbers(self, value):
        if __debug__:
            assert \
                ...
                "The 'numbers' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'numbers' field must be an unsigned integer in [0, 4294967295]"
        self._numbers = value
